...
class ILoNTest {
    ...
    void testGetValue() {
        ...
        assertThrows(ListOperationException.class, () -> mt.getValue(0));
        assertThrows(ListOperationException.class, () -> mt.getValue(6));
        ...
        assertThrows(ListOperationException.class, () -> one.getValue(3));
        assertThrows(ListOperationException.class, () -> fewExt.getValue(300));
        
        
        ListOperationException obj = assertThrows(ListOperationException.class, () -> fewExt.getValue(300));
        assertEquals(300, obj.getIndex());
